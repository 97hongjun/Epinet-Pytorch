...
def train(model: nn.Module, train_loader: FastTensorDataLoader, num_epochs: int, optimizer: torch.optim.Optimizer, device: str) -> nn.Module:
    model.train()
...
if __name__ == "__main__":
    ...
    model = train(model, train_loader, num_epochs=2, optimizer=optimizer, device=device)
